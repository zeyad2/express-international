...
const translations = {
  en: {
    ...
    "hero.premium.subtitle": "Bridging Borders, Empowering Trade",
    "hero.premium.description": "Discover a smarter way to move goods across the globe. From seamless customs clearance to tailored cargo solutions, we make international logistics faster, simpler, and more reliable",
    "hero.premium.cta": "Start Your Journey",
    "hero.premium.learnMore": "Explore Services",
    "hero.premium.stat1": "Years Of Experience",
    "hero.premium.stat2": "Countries Served",
    "hero.premium.stat3": "Customers Satisfied",
    ...
    "contact.businessHours.times": "Saturday - Thursday: 8:00 AM - 3:00 PM \nFriday: Closed",
  ...
  ar: {
    ...
    "hero.premium.subtitle": "نربط الحدود ونمكّن التجارة",
    "hero.premium.description": "اكتشف أسلوباً أذكى لنقل البضائع حول العالم. من التخليص الجمركي السلس إلى حلول الشحن المصممة خصيصاً لك، نجعل الخدمات اللوجستية الدولية أسرع وأسهل وأكثر اعتماداً",
    "hero.premium.cta": "ابدأ رحلتك",
    "hero.premium.learnMore": "استكشف خدماتنا",
    "hero.premium.stat1": "سنوات من الخبرة",
    "hero.premium.stat2": "دولة مخدومة",
    "hero.premium.stat3": "عملاء  سعداء",
    ...
    "contact.businessHours.times": "السبت - الخميس: 8:00 صباحًا - 3:00 مساءً\nالجمعة: مغلق",
