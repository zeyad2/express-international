...
import { TestTube, ChevronLeft, ArrowRight, CheckCircle, Shield, Globe, Zap } from 'lucide-react';
  ...
  const processSteps = [
    {
      ...
      title: t('labReagents.step1.title'),
      description: t('labReagents.step1.desc')
    },
    {
      icon: <Shield className="w-8 h-8 text-blue-800" />,
      title: t('labReagents.step2.title'),
      description: t('labReagents.step2.desc')
    },
    {
      icon: <Globe className="w-8 h-8 text-blue-800" />,
      title: t('labReagents.step3.title'),
      description: t('labReagents.step3.desc')
    },
    {
      icon: <Zap className="w-8 h-8 text-blue-800" />,
      title: t('labReagents.step4.title'),
      description: t('labReagents.step4.desc')
    }
  ];

  const features = [
    t('labReagents.feature1'),
    t('labReagents.feature2'),
    t('labReagents.feature3'),
    t('labReagents.feature4'),
    t('labReagents.feature5'),
    t('labReagents.feature6')
  ];

  const benefits = [
    t('labReagents.benefit1'),
    t('labReagents.benefit2'),
    t('labReagents.benefit3'),
    t('labReagents.benefit4')
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-96 bg-fixed bg-center bg-no-repeat mt-20" 
               style={{
                 backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/lab-hero.png")'
               }}>
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            <h1 className="text-5xl font-bold mb-4">{t('labReagents.title')}</h1>
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              {t('labReagents.subtitle')}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`grid lg:grid-cols-2 gap-12 items-center ${isRTL ? 'lg:grid-flow-col-dense' : ''}`}>
            ...
            >
              <h2 className="text-4xl font-bold text-gray-900 mb-6">{t('labReagents.title')}</h2>
              <p className="text-lg text-gray-700 mb-8">
                {t('labReagents.description')}
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">{t('labReagents.subtitle')}</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <TestTube className="w-8 h-8 text-blue-800 mb-4" />
      ...
      <section className="py-20 bg-blue-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl font-bold mb-6">{t('labReagents.ctaTitle')}</h2>
