...
import { Heart, ChevronLeft, ArrowRight, CheckCircle, Shield, Globe, Zap } from 'lucide-react';
  ...
  const processSteps = [
    {
      ...
      title: t('medicalSupplies.step1.title'),
      description: t('medicalSupplies.step1.desc')
    },
    {
      icon: <Shield className="w-8 h-8 text-blue-800" />,
      title: t('medicalSupplies.step2.title'),
      description: t('medicalSupplies.step2.desc')
    },
    {
      icon: <Globe className="w-8 h-8 text-blue-800" />,
      title: t('medicalSupplies.step3.title'),
      description: t('medicalSupplies.step3.desc')
    },
    {
      icon: <Zap className="w-8 h-8 text-blue-800" />,
      title: t('medicalSupplies.step4.title'),
      description: t('medicalSupplies.step4.desc')
    }
  ];

  const features = [
    t('medicalSupplies.feature1'),
    t('medicalSupplies.feature2'),
    t('medicalSupplies.feature3'),
    t('medicalSupplies.feature4'),
    t('medicalSupplies.feature5'),
    t('medicalSupplies.feature6')
  ];

  const benefits = [
    t('medicalSupplies.benefit1'),
    t('medicalSupplies.benefit2'),
    t('medicalSupplies.benefit3'),
    t('medicalSupplies.benefit4')
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-96 bg-fixed bg-center bg-no-repeat mt-20" 
               style={{
                 backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/doctors-hospital-design-superJumbo.jpg")'
               }}>
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            <h1 className="text-5xl font-bold mb-4">{t('medicalSupplies.title')}</h1>
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              {t('medicalSupplies.subtitle')}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`grid lg:grid-cols-2 gap-12 items-center ${isRTL ? 'lg:grid-flow-col-dense' : ''}`}>
            ...
            >
              <img 
                src="/images/medical_devices.jpg"
            ...
            >
              <h2 className="text-4xl font-bold text-gray-900 mb-6">{t('medicalSupplies.title')}</h2>
              <p className="text-lg text-gray-700 mb-8">
                {t('medicalSupplies.description')}
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">{t('medicalSupplies.subtitle')}</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <Heart className="w-8 h-8 text-blue-800 mb-4" />
      ...
      <section className="py-20 bg-blue-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl font-bold mb-6">{t('medicalSupplies.ctaTitle')}</h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              {t('medicalSupplies.ctaDesc')}
            </p>
            <Link 
              to="/#contact"
